...
size_t read_from_file(const char *file_path, const size_t buf_len,
                      uint8_t *buf);

size_t write_to_file(const char *file_path, const size_t buf_len,
                     const void *buf);
...
/*!
    ...
    The length of the char array public key is estimated from the algorithm and
   library.
 */
